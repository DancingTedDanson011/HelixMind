...
const COMMANDS: CommandDef[] = [
  ...
  { cmd: '/jarvis local', description: 'Switch to project-local Jarvis' },
  { cmd: '/jarvis global', description: 'Switch to global Jarvis' },
  { cmd: '/jarvis name', description: 'Set Jarvis custom name' },
