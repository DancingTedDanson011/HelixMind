...
const PHASE_COLORS: Record<string, string> = {
  ...
  deep: 'text-red-400 bg-red-500/10 border-red-500/20',
};

const DEPTH_COLORS: Record<string, string> = {
  surface: 'border-l-cyan-500/30',
  moderate: 'border-l-amber-500/30',
  deep: 'border-l-red-500/30',
};
      ...
      {entries.map((entry, i) => {
        ...
        return (
          <div key={i} className={`flex items-start gap-2 pl-2 border-l-2 ${depthColor}`}>
            ...
            <span className="text-[8px] px-1 py-0.5 rounded bg-red-500/10 text-red-400 border border-red-500/20 flex-shrink-0 mt-0.5">
              {entry.eventType}
            </span>
